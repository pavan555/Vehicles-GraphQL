...
export type Listing = {
  ...
  /** overall rating of the listing, calculated as the average of all reviews */
  overallRating: Scalars['Float']['output'];
  /** The reviews submitted by guests about the listing */
...
export type ResolversTypes = {
  Listing: ResolverTypeWrapper<ListingResponse>;
